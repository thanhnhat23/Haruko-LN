...
function EmojiPickerPopover({
  ...
  return (
    <div
      className={cn(
        "absolute top-full left-0 mt-2 z-50 shadow-2xl rounded-xl overflow-hidden border border-border bg-popover text-popover-foreground transition-all duration-150 origin-top",
        isOpen
    ...
    >
      ...
      >
        <EmojiPickerSearch placeholder={searchPlaceholder} />
        <EmojiPickerContent />
        <EmojiPickerFooter />
      </EmojiPicker>
    </div>
