        ...
        <footer className="border-t border-border/40 bg-card/45 backdrop-blur-xs py-12 sm:py-16 z-1 text-xs text-muted-foreground transition-colors duration-300">
            ...
            <div className="lg:col-span-2 space-y-3">
                ...
                <ul className="space-y-2 font-medium">
                    ...
                    <li><Link href="/policy" className="hover:text-foreground transition-colors">Chính sách bảo mật</Link></li>
            ...
            <div className="w-full max-w-360 mx-auto px-4 sm:px-8 mt-12 pt-6 border-t border-border/40 flex flex-col sm:flex-row justify-between items-center gap-4 text-[10px] text-muted-foreground/70">
