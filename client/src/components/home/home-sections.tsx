...
import { Compass, Sparkles, CheckCircle2, Award, ChevronRight } from "lucide-react"
import { VerticalCard, HorizontalCard } from "./novel-card"

// Mock datasets (10 items for Translated, 5 for AI, 6 for Completed, 6 for Top Novels)
...
const AI_TRANSLATED_NOVELS = [
  ...
  { id: 2, title: "Sword Art Online: Unital Ring", author: "Reki Kawahara", image: "https://i.pinimg.com/originals/2c/83/ff/2c83ff0cbb92ef28ba5e325fae6315d9.gif", views: "250k", rating: "4.6", chapters: "Chương 35" },
  { id: 3, title: "Overlord: Volume 16", author: "Kugane Maruyama", image: "https://i.pinimg.com/originals/d5/21/e1/d521e1a0f03c26a5caa225e60faa608f.gif", views: "185k", rating: "4.8", chapters: "Chương 18 (Hoàn thành)" },
  { id: 4, title: "Monogatari: Owarimonogatari", author: "Nisio Isin", image: "https://i.pinimg.com/originals/c5/bf/9b/c5bf9b4801ee89b2c9d56924a9357217.gif", views: "98k", rating: "4.8", chapters: "Chương 42" },
  { id: 5, title: "Kimi no Na wa: Another Side", author: "Arata Kanoh", image: "https://i.pinimg.com/originals/4e/2a/f4/4e2af41014d87c89b468cad0080667ca.gif", views: "142k", rating: "4.9", chapters: "Chương 24 (Hoàn thành)" }
]
...
export function AiTranslatedSection() {
  return (
    <section className="space-y-4">
      <div className="flex items-center gap-2.5 border-b border-border/40 pb-2">
        <div className="bg-zinc-800 text-zinc-100 dark:bg-zinc-800 dark:text-zinc-100 font-extrabold text-[9px] tracking-wider px-2 py-0.5 rounded-xs uppercase select-none shrink-0">
        ...
        <h3 className="text-base font-black uppercase tracking-wider text-foreground flex gap-2 items-center">
          AI dịch
          <Sparkles className="size-4 text-yellow-400 dark:text-yellow-300 mr-1" />
        </h3>
      </div>
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
        {AI_TRANSLATED_NOVELS.map((novel, index) => (
          <div key={novel.id} className={index >= 4 ? "hidden sm:block" : ""}>
            <VerticalCard novel={novel} />
          </div>
        ))}
